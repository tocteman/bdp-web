  ...
  <div className="flex h-auto relative w-full mt-0 p-12 text-center self-center mb-8">
      ...
      <div className="flex flex-wrap p-4 text-center mx-auto">
          ...
          <h1 className="text-grey-lightest mb-4 leading-normal">Tu vida.<br /> Tus reglas.<br /> Tus ahorros.</h1>
            <p className="font-light mb-4 text-grey-light text-center leading-normal ">Übank es la forma más fácil y entretenida para ahorrar y hacer tus sueños realidad.</p>
          <button className="bg-teal-darkest rounded-full px-4 py-2 text-sm text-grey-lightest mb-8 hover:text-teal-darkest hover:bg-white">Download</button>
          </div>
    ...
    <div className="flex pt-8 px-8 pb-4 mx-auto text-teal-darkest">
    ...
    <div className="flex flex-wrap p-4 max-w-xl mx-auto items-center text-teal-darkest">
    ...
    <div className="md:w-1/3 p-4">
        ...
        <p className="max-w-sm leading-normal">Cuando las <em>Reglas</em> se activan, transferimos el dinero a una cuenta de ahorro. Siempre estará seguro y disponible.</p>
    </div>
  </div>
  
  <div className="flex flex-wrap pt-8 m-8 bg-grey-lighter max-w-xl mx-auto">
    <div className="sm:w-full md:w-1/2 pt-4 px-4 pb-0 mx-auto md:p-8">
      <div className="flex">
        <div className="wt-1/3 p-2">
          <div className="bg-teal-darker w-16 h-16 rounded-full shadow-md">
              <FaBuildingO className="mt-4 ml-4 text-3xl text-white text-center"/>
          </div>
        </div>
        <div className="wt-2/3 p-2">
            <h3 className="leading-normal font-medium">Multibanco</h3>
        ...
        <div className="flex">
          ...
          <div className="wt-2/3 p-2">
            <h3 className="leading-normal font-medium">Recomendaciones</h3>
      ...
      <div className="sm:w-full md:w-1/2 mx-auto pl-4 py-4 md:p-8">
        <div className="flex">
          ...
          <div className="wt-2/3 p-2">
            <h3 className="leading-normal font-medium">Claridad</h3>
        ...
        <div className="flex">
          ...
          <div className="wt-2/3 p-2">
            <h3 className="leading-normal font-medium">Rentabilidad</h3>
