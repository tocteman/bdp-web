...
const AboutPage = () => (
  <div className="flex flex-col md:flex-row items-center max-w-xl mx-auto">
    <div className="md:w-3/5 md:mr-8">
      <p className="border-l-4 border-grey-darkest font-serif leading-loose p-6 pl-4 text-justify">
    ...
    <div className="w-2/5 md:ml-8 md:w-1/3">
      <img src={cautiousDog} />
    </div>
  </div>
);
